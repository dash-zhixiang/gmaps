...
class Drawing(GMapsWidgetMixin, widgets.Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._delete_features_callbacks = []
    ...
    def on_delete_feature(self, callback):
        self._delete_features_callbacks.append(callback)
        ...
        if self._delete_features_callbacks:
            for feature in self.features:
                if feature.model_id == model_id:
                    for callback in self._delete_features_callbacks:
                        callback(feature)
                    break

    def _delete_feature(self, model_id):
        self._on_delete_features(model_id)
